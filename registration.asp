				...
				<div align="left">
					<table border="0" width="796" id="table5" cellspacing="0">
						<tr>
							...
							<IMG height=82 src="images/lo.png" border=0 style="width: 284px"></td>
							<td width="30">&nbsp;</td>
	...
	<table border="0" width="100%" id="table6" cellpadding="2">
		<tr>
			...
			<td colspan="3" align="left">
                <strong><br>
				Student Registration. Fill the form carefully all fields are 
				mandatory.</strong></td>
		</tr>
        <tr>
		...
		<tr>
			...
			<td style="WIDTH: 371px; HEIGHT: 15px" align="left">&nbsp;<FONT size="1" color="#626258" face="Verdana, Arial, Helvetica, sans-serif"><INPUT name="studentname" size="24" maxlength="15" minlength="5"  class="textb1"
                 ></FONT></td>
		...
		<tr>
			...
			<td align="left" style="WIDTH: 174px">
                &nbsp;Pin Code:</td>
			<td style="WIDTH: 371px" align="left">&nbsp;<FONT size="1" color="#626258" face="Verdana, Arial, Helvetica, sans-serif"><INPUT name="regioncode" size="8" maxlength="6" minlength="6" class="textb1"
                 ></FONT></td>
			<td width="89">&nbsp;</td>
		</tr>
		<tr>
			...
			<td align="left" style="WIDTH: 174px">
                &nbsp;Mobile No:</td>
			<td style="WIDTH: 371px" align="left">&nbsp;<FONT size="1" color="#626258" face="Verdana, Arial, Helvetica, sans-serif"><INPUT name="tlccode" size="12" maxlength="9" minlength="7" class="textb1"
                 ></FONT></td>
			<td width="89">&nbsp;</td>
		</tr>
		<tr>
			...
			<td align="left" style="WIDTH: 174px">
                &nbsp;Interest:</td>
			<td style="WIDTH: 371px" align="left"><input type="radio" value="P" name="stream_p"  >Devloping&nbsp;
			<input type="radio" value="M" checked name="stream_m">Designing</td>
			<td width="89">&nbsp;</td>
		</tr>
		<tr>
			<td width="16">&nbsp;</td>
			<td align="left" style="WIDTH: 174px">
                &nbsp;Year of passing UG:</td>
