...
<head id="Head1" runat="server">
    ...
    <title>Way 2 Mca :: Start Test</title>
				...
				<div align="left">
					<table border="0" width="796" id="table5" cellspacing="0">
						<tr>
							...
							<IMG height=82 src="images/lo.png" border=0 style="width: 264px"></td>
							<td width="30">&nbsp;</td>
						...
						<tr>
							...
							Home</A> | <A href="starttest.asp">Test</A>&nbsp; |&nbsp;<A href="changepassword.asp">Change Password</a>&nbsp; |
	...
	<table border="0" width="100%" id="table6" cellpadding="2">
		...
		<tr>
			...
			<td style="HEIGHT: 15px" align="left" colspan="2">
                <b>Examination : <font color="#ff0000" size="2">Online Quiz</font></b></td>
        ...
        <tr>
            ...
            <b>NOTE : Test will have 10 questions Each question will have 4 
