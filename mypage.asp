				...
				<div align="left">
					<table border="0" width="796" id="table5" cellspacing="0">
						<tr>
							...
							<IMG height=82 src="images/lo.png" border=0 style="width: 279px"></td>
							<td width="30">&nbsp;</td>
			...
			<table border="1" width="437" cellspacing="1" style="border-collapse: collapse" bordercolor="#434367" id="table7">
				...
				<%
					...
					while rs.eof=false
						c=c+1
						response.write("<tr>")
							response.write("<td width='68' align='center' valign='top'>" &"NIMCET_" & c & "</td>")
